...
const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-10 right-10 z-50 bg-[#0f0f0f] border w-[20%] px-[4rem] mb-[2rem] rounded">
    <section className="flex justify-between items-center text-white">
      ...
      <div className="flex justify-center items-center mb-[2rem]">
        ...
        >
          <AiOutlineTable className="mr-2 mt-[3rem]" size={26} />
          <span className="hidden nav-item-name mt-[3rem]">TimeTable</span>
        </Link>
      </div>
      {/* Section 2 */}
